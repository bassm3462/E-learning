...
if(isset($_POST['update'])){
  ...
  $update_profile->bindParam(":id",$student_id);
  ...
  $update_image->bindParam(":ID",$student_id);
         ...
         if($update_image){
            ...
            if($fetch_profile['image']=="images_pofile.png"){
   ...
   if(!empty($previous_pass) || !empty($new_pass) || !empty($confirm_pass)){
      if($previous_pass != $old_pass){
         ...
         $update_password->bindParam("id",$student_id);
...
?>
    ...
    <h1 class="title"> update <span>Student</span> profile </h1>
   ...
   ?>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="flex-btn">
                ...
                <a href="students/hom.php" class="option-btn">go back</a>
            </div>
        </form>
