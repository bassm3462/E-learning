...
<body>
    ...
    ?>
    <?php
    // die($_SESSION['student_id']);
    $dsiplay = $conn->prepare("SELECT*FROM assignment WHERE ID=$_GET[id]");
    $dsiplay->execute();
            ...
            <div class="information_box">
                <div class="box_info container">
                    <div class="assimgint_detalis">
                        <h3><?php echo $value['name_ASSINMINT'] ?></h3>
                    ...
                    <div class="submit_assig">
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="">
                                <input class="hidden_file" type="file" name="upload" id="file_sent">
                                <label class="image_upload" for ="file_sent"><img src="../../frontend/image/upload-file.png" alt="" class="image_sent"></label>
                            </div>
